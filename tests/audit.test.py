...
if path and os.path.exists(path):
    ...
    cases = [
      ...
      ("前环", find("ring", False, lambda e: abs(e["z"]-0.05)<0.02 and e["r"]>0.1), {"r": 0.125, "size": 0.004}),
      ("前中心环", find("ring", False, lambda e: abs(e["z"]-0.05)<0.02 and e["r"]<0.1), {"r": 0.045, "size": 0.008}),
      ("电机", find("disc", False, lambda e: abs(e["z"]+0.1)<0.02), {"r": 0.05, "thick": 0.09}),
      ("固定盘", find("disc", False, lambda e: abs(e["z"])<0.02 and e["r"]>0.05), {"r": 0.058, "thick": 0.004}),
      ("前脸圆", find("disc", False, lambda e: abs(e["z"]-0.035)<0.02), {"r": 0.035}),
      ("前轴", find("disc", False, lambda e: abs(e["z"]+0.0275)<0.01 and e["r"]<0.03), {"r": 0.02, "thick": 0.055}),
      ("后轴", find("disc", False, lambda e: abs(e["z"]+0.155)<0.02), {"r": 0.015, "thick": 0.02}),
      ("底座", find("disc", False, lambda e: e["r"]>0.1), {"r": 0.13, "thick": 0.02}),
      ("叶片组", find("el-disc", True, lambda e: e["n"]==3), {"radius": 0.076, "rx": 0.042, "pitch": 12, "z": 0.0}),
      ("后罩组", find("arc", True, lambda e: e["n"]==36 and e["zBase"]<0), {"len": 0.125, "size": 0.0015, "zBase": -0.05}),
      ("前罩组", find("arc", True, lambda e: e["n"]==36 and e["zBase"]>0), {"len": 0.125, "size": 0.0015, "zBase": 0.05}),

...
if path and os.path.exists(path):
    ...
    cases = [
      ...
      ("前环", find("ring", False, lambda e: abs(e["z"]-0.05)<0.02), {"r": 0.125, "size": 0.0063}),
      ...
      ("轴", find("disc", False, lambda e: abs(e["z"]+0.175)<0.02), {"r": 0.015, "thick": 0.06}),
      ("底座", find("disc", False, lambda e: e["r"]>0.1), {"r": 0.13, "thick": 0.02}),
      ("叶片组", find("el-disc", True, lambda e: e["n"]==3), {"radius": 0.076, "rx": 0.03, "pitch": 12, "z": 0.0}),
      ("后罩组", find("arc", True, lambda e: e["n"]==30 and e["zBase"]<0), {"len": 0.125, "size": 0.0022, "zBase": -0.05}),
      ("前罩组", find("arc", True, lambda e: e["n"]==30 and e["zBase"]>0), {"len": 0.125, "size": 0.0022, "zBase": 0.05}),

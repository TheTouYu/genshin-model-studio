...
surface(mirrorRings(TORSO_R, 1), U, function (i) {
  ...
  return r.y < 0.44 ? SKIN : (r.y < 0.92 ? WHITE : SKIN);
}, 0.0012);
var jerseyRings = ringsBetween(TORSO_R, 0.60, 0.92, 8);
...
var shortsRings = ringsBetween(TORSO_R, 0.44, 0.62, 6);
surface(offsetRings(shortsRings, 0.006), U, function (i, j) { return WHITE; }, 0.0016);
window.gms.part('disc', { x: 0, y: 0.62, z: -0.02, r: 0.060, thick: 0.012, axis: 'up', color: BLUE });
...
// 背后 GANYU + 10
letter(-0.075, 0.86, 'G', -0.075, 0.004, BLUE);
letter(-0.029, 0.86, 'A', -0.075, 0.004, BLUE);
letter(0.017, 0.86, 'N', -0.075, 0.004, BLUE);
letter(0.063, 0.86, 'Y', -0.075, 0.004, BLUE);
letter(0.109, 0.86, 'U', -0.075, 0.004, BLUE);
window.gms.part('rod', { x1: 0.032, y1: 0.775, z: -0.075, x2: 0.032, y2: 0.705, size: 0.006, color: BLUE });
window.gms.part('disc', { x: 0.070, y: 0.74, z: -0.075, r: 0.022, thick: 0.002, axis: 'front', color: BLUE });
// 胸前 10

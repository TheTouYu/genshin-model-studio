...
function arm(side) {
  surface([
    ...
    { y: 0.68, cx: side * 1.52, rx: 0.020, ry: 0.020, cz: 0.04 },
  ], Math.round(U * 0.7), function (i) { return SKIN; }, 0.0012);
  surface(offsetRings([
    { y: 0.93, cx: side * 1.0, rx: 0.024, ry: 0.024, cz: 0.0 },
    { y: 0.88, cx: side * 1.22, rx: 0.026, ry: 0.026, cz: 0.005 },
    { y: 0.80, cx: side * 1.34, rx: 0.024, ry: 0.024, cz: 0.02 },
  ], 0.006), Math.round(U * 0.7), function () { return WHITE; }, 0.0014);
  window.gms.part('disc', { x: side * 1.34, y: 0.80, z: 0.02, r: 0.027, thick: 0.009, axis: 'up', color: BLUE });

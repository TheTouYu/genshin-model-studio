/* ⚠ 自动生成，勿手改 —— 真源 reference/macbook/screen-ui/screen-ui-layout.mjs
...
const SCREEN = { w: 0.3024, h: 0.1964 };
const THICK = 0.0004;   // 单块板厚
const Z_STEP = 0.0005;  // 层间距
const MIN_SHORT = 0.0022;  // 短边视觉下限（m）；引擎硬下限见 ASPECT_MAX
const ASPECT_MAX = 200;    // 长边/短边 ≤ 200
...
function toWorld(local, { hingeZ = -0.1000, hingeY = 0.0115, angleDeg = 100, centerX = 0, vOffset = 0.0096 } = {}) {
...
function lidNormal(angleDeg = 100) {
  const t = (angleDeg * Math.PI) / 180;

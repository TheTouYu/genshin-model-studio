...
function arm(side) {
  surface([
    ...
    { y: 0.79, cx: side * 1.15, rx: 0.024, ry: 0.024, cz: 0.02 },
    { y: 0.74, cx: side * 1.28, rx: 0.022, ry: 0.022, cz: 0.03 },
    { y: 0.63, cx: side * 1.52, rx: 0.020, ry: 0.020, cz: 0.04 },
  ...
  window.gms.part('disc', { x: side * 1.66, y: 0.60, z: 0.04, r: 0.024, thick: 0.016, axis: 'front', color: GLOVE });
}
arm(-0.105);
arm(0.105);

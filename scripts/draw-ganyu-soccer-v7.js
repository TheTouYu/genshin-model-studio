...
// 躯干皮肤（下身露出大腿根、颈部上下露肤）
surface([
  { y: 0.585, rx: 0.108, ry: 0.076, cz: 0 },
  { y: 0.70, rx: 0.092, ry: 0.062, cz: 0 },
  { y: 0.80, rx: 0.094, ry: 0.068, cz: 0.004 },
  { y: 0.90, rx: 0.088, ry: 0.058, cz: 0 },
], U, function () { return SKIN; }, 0.0012);
/* ---------- 球衣壳层（独立面：外扩 0.008，白底 + 蓝斜纹/蓝腰条/蓝领） ---------- */
var jerseyRings = [
  { y: 0.615, cx: 0, cz: 0, rx: 0.108, ry: 0.076 },
  { y: 0.66, cx: 0, cz: 0, rx: 0.098, ry: 0.066 },
  { y: 0.72, cx: 0, cz: 0, rx: 0.102, ry: 0.070 },
  { y: 0.82, cx: 0, cz: 0.005, rx: 0.104, ry: 0.076 },
  { y: 0.90, cx: 0, cz: 0, rx: 0.098, ry: 0.064 },
  { y: 0.945, cx: 0, cz: 0, rx: 0.088, ry: 0.056 },
];
...
window.gms.part('disc', { x: 0, y: 0.945, z: 0, r: 0.056, thick: 0.012, axis: 'up', color: BLUE });
window.gms.part('disc', { x: 0, y: 0.615, z: 0, r: 0.11, thick: 0.011, axis: 'up', color: BLUE });

/* ---------- 短裤壳层（独立面：外扩 0.006，白 + 蓝腰/侧条） ---------- */
var shortsRings = [
  { y: 0.515, cx: 0, cz: 0, rx: 0.118, ry: 0.088 },
  { y: 0.585, cx: 0, cz: 0, rx: 0.121, ry: 0.091 },
  { y: 0.66, cx: 0, cz: 0, rx: 0.117, ry: 0.087 },
];
surface(offsetRings(shortsRings, 0.006), U, function (i, j) { return WHITE; }, 0.0016);
window.gms.part('disc', { x: 0, y: 0.66, z: 0, r: 0.121, thick: 0.012, axis: 'up', color: BLUE });
...
function leg(cx) {
  ...
  ], Math.round(U * 0.8), function () { return SKIN; }, 0.0012);
  surface(offsetRings([
    { y: 0.035, cx: cx, rx: 0.030, ry: 0.032, cz: 0 },
    { y: 0.13, cx: cx, rx: 0.032, ry: 0.034, cz: 0 },
    { y: 0.24, cx: cx, rx: 0.034, ry: 0.036, cz: 0 },
    { y: 0.315, cx: cx, rx: 0.035, ry: 0.037, cz: 0 },
    { y: 0.335, cx: cx, rx: 0.033, ry: 0.035, cz: -0.004 },
  ], 0.005), Math.round(U * 0.8), function () { return SOCK; }, 0.0014);
  window.gms.part('disc', { x: cx, y: 0.322, z: 0, r: 0.037, thick: 0.011, axis: 'up', color: BLUE });
}
leg(-0.062);
leg(0.062);
...
function arm(side) {
  ...
  surface(offsetRings([
    { y: 0.93, cx: side, rx: 0.024, ry: 0.024, cz: 0.0 },
    { y: 0.88, cx: side * 1.06, rx: 0.026, ry: 0.026, cz: 0.005 },
    { y: 0.80, cx: side * 1.22, rx: 0.024, ry: 0.024, cz: 0.02 },
  ], 0.006), Math.round(U * 0.7), function () { return WHITE; }, 0.0014);
  window.gms.part('disc', { x: side * 1.22, y: 0.80, z: 0.02, r: 0.027, thick: 0.009, axis: 'up', color: BLUE });
  window.gms.part('disc', { x: side * 1.44, y: 0.665, z: 0.04, r: 0.024, thick: 0.016, axis: 'front', color: GLOVE });
}
arm(-0.125);
arm(0.125);
